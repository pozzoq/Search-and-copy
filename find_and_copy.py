...
class FileSearchGUI:
    def __init__(self, master):
        ...
        self.browse_filename_button.grid(row=0, column=2, padx=10, pady=10)

        self.destination_folder_label = tk.Label(self.master, text="Enter the destination folder:")
        self.destination_folder_label.grid(row=1, column=0, padx=10, pady=10)

        self.destination_folder_entry = tk.Entry(self.master)
        self.destination_folder_entry.grid(row=1, column=1, padx=10, pady=10)

        self.browse_destination_folder_button = tk.Button(self.master, text="Browse", command=self.browse_destination_folder)
        self.browse_destination_folder_button.grid(row=1, column=2, padx=10, pady=10)
